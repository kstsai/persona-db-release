...
**共 10 種不同契約**（v5.2 與 v5.3.1 同 hash ⇒ 純行為 patch；第 5–7 輪同為 `aafe647f`；v5.7 `cb5b0808`；v5.8 `6d3c1508`；v5.10 `588772d4`；v5.11.1 `c17043b4`；v5.12 `38009c9f`；**v5.13 為新契約 `d1da178b`**）。
...
| 代號 | 對應 |
|:---|:---|
| `NODE-A` | 第一／三／七／九／十／十一／十二／十三輪的受測節點 |
