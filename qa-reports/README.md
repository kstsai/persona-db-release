...
**共 8 種不同契約**（v5.2 與 v5.3.1 同 hash ⇒ 純行為 patch；第 5–7 輪同為 `aafe647f`；v5.7 `cb5b0808`；v5.8 `6d3c1508`；v5.10 `588772d4`；**v5.11.1 為新契約 `c17043b4`**）。
