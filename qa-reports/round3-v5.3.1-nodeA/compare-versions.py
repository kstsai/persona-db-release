...
A_DIR = sys.argv[1] if len(sys.argv) > 1 else '/Users/kstsai/Documents/round1-v4.9.2-nodeA'
B_DIR = sys.argv[2] if len(sys.argv) > 2 else '/Users/kstsai/Documents/round2-v5.2-nodeB'
