...
| v5.3.1 | NODE-A (NODE-A) | `../round3-v5.3.1-nodeA/` |
...
```bash
cd /Users/kstsai/Documents/round4-v5.4-nodeB
...
for d in ../round1-v4.9.2-nodeA ../round2-v5.2-nodeB ../round3-v5.3.1-nodeA; do
...
echo "v5.3.1: $(jq -r '[.summary[].debt_status]|group_by(.)|map("\(.[0]):\(length)")|join("  ")' ../round3-v5.3.1-nodeA/json/07_debt.json)"
...
echo "v5.3.1: matched=$(jq -r .total_matched ../round3-v5.3.1-nodeA/json/06_aesthetic.json) returned=$(jq -r .returned ../round3-v5.3.1-nodeA/json/06_aesthetic.json)"
